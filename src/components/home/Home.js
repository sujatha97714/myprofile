    ...
    return <div className={styles.home}>
        <div className={styles.wrapper}>
            ...
            <div className={styles.description}>
                &#128187; A programming enthusiast exploring the maze of web technologies. <br/> &#128151; I love developing complex aesthetic user interfaces. <br/> &#128161; Technical mentor guiding freshers aspring to enter the software world 
            </div>
        </div>
    </div>
}